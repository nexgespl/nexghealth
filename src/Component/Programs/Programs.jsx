...
const Programs = () => {
  return (
    <section className="py-12 border-y border-slate-200 bg-white text-center">
      ...
      <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-50 grayscale hover:grayscale-0 transition-all duration-300">
        ...
        <span className="text-xl font-bold">HCA Healthcare</span>
        <span className="text-xl font-bold">CommonSpirit</span>
        <span className="text-xl font-bold">Tenet Health</span>
        <span className="text-xl font-bold">Kaiser</span>
      </div>
    </section>
  );
};
